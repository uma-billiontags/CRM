...
const ADD_URL  = "https://onboard-form-7.onrender.com/add_campaign/";
const EDIT_URL = "https://onboard-form-7.onrender.com/edit_campaign/";
const GET_URL  = "https://onboard-form-7.onrender.com/campaign_list/";
...
export default function Portal_Campaigns() {
  ...
  const postCampaign = async (f: CampaignForm, campaignId?: string): Promise<boolean> => {
    setSubmitting(true);
    setSubmitError("");
    const url = campaignId ? EDIT_URL : ADD_URL;
    try {
              ...
              campaigns.map((c) => (
                <tr
                  ...
                  className={`border-t border-border hover:bg-muted/30 transition-colors ${
                    activeId === c.campaign_id ? "bg-primary/5" : ""
                  }`}
                >
